...
def print_scores(scores, etype):
    ...
    if etype in ["all", "custom-exec"]:
        print('=====================   CUSTOM EXECUTION ACCURACY     =====================')
        this_scores = [scores[level]['custom-exec'] for level in levels]
        print("{:20} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.3f}".format("execution", *this_scores))
...
def evaluate(gold, predict, db_dir, etype, kmaps, table):
    ...
    for level in levels:
        ...
        if etype in ["all", "custom-exec"]:
            scores[level]['custom-exec'] /= scores[level]['count']
...
if __name__ == "__main__":
    ...
    assert etype in ["all", "exec", "match", "custom-exec"], "Unknown evaluation method"
